...
-- Insert data for the services table
INSERT INTO `services` (`serviceName`, `serviceDescription`, `servicePrice`) VALUES
('Room Service', '24/7 in-room dining with a variety of meal options.', 20.00),
('Spa', 'Relaxing spa treatments including massages and facials.', 50.00),
('Laundry', 'Quick and professional laundry services.', 15.00),
('Gym Access', 'Full access to the hotel gym with modern equipment.', 10.00),
('Airport Shuttle', 'Comfortable transport to and from the airport.', 30.00);
--
